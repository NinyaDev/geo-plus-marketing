        ...
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="mt-16 grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div className="group relative rounded-2xl border border-slate-200 bg-white p-8 shadow-sm transition hover:border-accent/40 hover:shadow-lg hover:shadow-accent/5">
              ...
              <h3 className="text-lg font-bold text-slate-900">GBP Optimization</h3>
              <p className="mt-2 text-sm leading-relaxed text-muted">
            ...
            <div className="group relative rounded-2xl border border-slate-200 bg-white p-8 shadow-sm transition hover:border-accent/40 hover:shadow-lg hover:shadow-accent/5">
              ...
              <h3 className="text-lg font-bold text-slate-900">Website &amp; Funnel Optimization</h3>
              <p className="mt-2 text-sm leading-relaxed text-muted">
        ...
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="mt-16 grid gap-10 md:grid-cols-3">
            <div className="relative rounded-2xl border border-slate-200 bg-white p-8 shadow-sm">
              ...
              <h3 className="mt-2 text-lg font-bold text-slate-900">Deep-Dive Audit</h3>
            ...
            <div className="relative rounded-2xl border border-slate-200 bg-white p-8 shadow-sm">
              ...
              <h3 className="mt-2 text-lg font-bold text-slate-900">Autonomous Execution</h3>
              <p className="mt-3 text-sm leading-relaxed text-muted">
            ...
            <div className="relative rounded-2xl border border-slate-200 bg-white p-8 shadow-sm">
              ...
              <h3 className="mt-2 text-lg font-bold text-slate-900">Measurable Growth</h3>
              <p className="mt-3 text-sm leading-relaxed text-muted">
